...
const FacebookCallback = () => {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      try {
        ...
        await handleFacebookLogin(code);
        
        // if success, redirect to home page
        navigate('/', { replace: true });
      } catch (err) {
        console.error('Lỗi OAuth với Facebook:', err);
  ...
  }, [location, navigate, handleFacebookLogin]);
    ...
    return (
      <div className="oauth-callback-container">
        <div className="oauth-error">
          <h2>Lỗi Xác Thực</h2>
          <p>Đã xảy ra lỗi khi đăng nhập bằng Facebook:</p>
          <p><code>{error}</code></p>
